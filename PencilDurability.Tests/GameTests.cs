...
namespace PencilDurability.Tests
{
    public class GameTests
    {
        ...
        public void GivenAGameIsStarted_WhenAnAnswerIs2ThenWrite_ThenTheGameWillWrite()
        {
            ...
            _sut.Start();
            _mockDevice.Verify(d => d.WriteOn("hello", _mockSurface.Object, null));
        }
        ...
        [Fact]
        public void GivenAGameIsStarted_WhenAnAnswerIs2ThenWriteWithoutText_ThenTheGameWillReprompt()
        {
            InSequenceAndQuit(_mockInput, t => t.ReadLine(), "2", "write");
            _sut.Start();
            _mockDevice.Verify(d => d.WriteOn(It.IsAny<string>(), _mockSurface.Object, null), Times.Never);
        }
        ...
        public void GivenAGameIsStarted_WhenAnAnswerIs2ThenEdit_ThenTheGameWillEditWithOneWord()
        {
            ...
            _sut.Start();
            _mockDevice.Verify(d => d.WriteOn("hello", _mockSurface.Object, 2));
        }
        ...
        public void GivenAGameIsStarted_WhenAnAnswerIs2ThenEdit_ThenTheGameWillEditWithMultipleWords()
        {
            ...
            _sut.Start();
            _mockDevice.Verify(d => d.WriteOn("hello sally how's the sea?", _mockSurface.Object, 2));
        }
        ...
        public void GivenAGameIsStarted_WhenAnAnswerIs2ThenEditWithoutText_ThenTheGameWillReprompt()
        {
            ...
            _sut.Start();
            _mockDevice.Verify(d => d.WriteOn(It.IsAny<string>(), _mockSurface.Object, 2), Times.Never);
        }
        ...
        public void GivenAGameIsStarted_WhenAnAnswerIs2ThenEditWithoutAValidNumber_ThenTheGameWillReprompt()
        {
            ...
            _sut.Start();
            _mockDevice.Verify(d => d.WriteOn(It.IsAny<string>(), _mockSurface.Object, It.IsAny<int>()), Times.Never);
        }
